...
Pravi sliku sa objasnjenjem (na ijekavici) koji ulazni niz daje izlaz 'aacbbca'
i zasto, uz pricu o "Maximal Munch" pravilu kod flex skenera.
Izlaz:  flex_rjesenje_ijekavica.png

Kako radi: napravimo komad HTML-a (tekst + stilovi) pa ga html2image
"slika" u PNG. Tekst objasnjenja je u <body>, a izgled (font, boje) u <style>.

Pokretanje:  python3 ulazni_niz.py   (treba paket html2image)
"""

from html2image import Html2Image

# gdje snimamo i kako se zove slika + dimenzije platna
IZLAZNI_FOLDER = '.'
IME_SLIKE = 'flex_rjesenje_ijekavica.png'
VELICINA = (880, 950)

# alat koji HTML pretvara u sliku
hti = Html2Image(output_path=IZLAZNI_FOLDER)

# Cijelo objasnjenje kao HTML. Verdana 12pt, podvuceni "leksemi" da se vidi
# kako se ulazni niz dijeli na tokene.
html_str = """
<!DOCTYPE html>
<html>
<head>
...
# napravi PNG iz gornjeg HTML-a
print("Generišem sliku...")
hti.screenshot(html_str=html_str, save_as=IME_SLIKE, size=VELICINA)
print(f"Slika '{IME_SLIKE}' je uspješno kreirana!")
